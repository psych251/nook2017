...
Do to funding limitations, we may only be able to run 60 participants. If this replication is run with 60 participants, it will be able to detect the same effect with 78% power. However, the final power with likely be less than 78% after accounting for likely exclusions.
